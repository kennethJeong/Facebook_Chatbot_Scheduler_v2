...
include_once $docRoot.'/test/dbInfo.php';
include_once $docRoot.'/test/lib.php';
foreach(glob($docRoot.'/test/function/*.php') as $functionFiles)
{
    include_once $functionFiles;
}
include_once $docRoot.'/test/config.php';
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
include_once $docRoot.'/test/pnu/crontab/cronLib.php';
include_once $docRoot.'/test/pnu/crontab/cronConfig.php';
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// Executing list of Crontabs
//// 해당 년도 db 생성(course + (해당년도)) 후, course INSERT+UPDATE 크론탭
include_once $docRoot.'/test/pnu/crontab/parsingCourses.php';
//
//// 수업 종료 후 푸시 크론탭
// include_once $docRoot.'/test/pnu/crontab/pushAfterClass.php';
//
//// 출첵 크론탭
include_once $docRoot.'/test/pnu/crontab/pushAttendance.php';
//
//// 등록된 과제,휴강,시험 푸시 크론탭 (매일 오전 8시에 한번만)
include_once $docRoot.'/test/pnu/crontab/pushEvents.php';
//