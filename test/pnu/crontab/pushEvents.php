...
if(!in_array($today, $yearsSchedule['dayoff'])) {
	...
	if($termOfSeason || ($termOfRegular && $termOfRegularFromStartToEnd)) {
		...
		// 매일 오전 8시마다 알림
		//
		if($now == mktime(8,0,0,date("m"),date("d"),date("Y"))) {
